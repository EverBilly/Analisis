...
<div class="container">
	...
	<table class="table table-hover tabla-usuarios">
	      ...
	      <tbody>
	        ...
	        <td>
	        	{!!link_to_route('municipio.edit', $title = 'Editar', $parameters = Crypt::encrypt($municipio->id), $attributes = ['class' => 'btn btn-warning'])!!}
	        </td>
	      </tbody>
	      @endforeach
	    </table>
	...
	{!!Form::submit('Crear municipio', ['class' => 'btn btn-primary', 'data-toggle' => 'modal', 'data-target' => '#registrar'])!!}
	<br>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="inicio">Registro de municipios</h4>
				</div>
				<div class="modal-body">
						{!! Form::open(array('url'=>'municipio', 'method'=>'POST')) !!}
							<div class="form-group">
								{!!Form::label('Nombre')!!}
								{!!Form::text('municipio', null, ['class' => 'form-control', 'placeholder' => 'Ingrese El Nombre', 'required'])!!}
							</div>
							<div class="form-group">
