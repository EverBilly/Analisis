...
@section('content')
	...
	<div class="container">
		{!! Form::model($municipio, ['route' => ['municipio.update', $municipio -> id], 'method' => 'PUT']) !!}
			...
			{!!link_to('municipio/create', $title = 'Cancelar', $attributes = ['class' => 'btn btn-warning'], $secure = null)!!}
			</div>
		{!! Form::close() !!}
	</div>
  ...
  <!--Boton para eliminar Usuarios-->
  	<div class="container">
		{!! Form::open(['route' => ['municipio.destroy', Crypt::encrypt($municipio -> id)], 'method' => 'DELETE']) !!}
