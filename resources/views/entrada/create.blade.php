...
<div class="container">
	...
	<table class="table table-hover tabla-usuarios">
	      ...
	      <tbody>
	        ...
	        <td>{{ $entrada->total }}</td>
	        <td>
	        	{!!link_to_route('entrada.edit', $title = 'Editar', $parameters = Crypt::encrypt($entrada->id), $attributes = ['class' => 'btn btn-warning'])!!}
	        </td>
	      </tbody>
	      @endforeach
	    </table>
	...
	{!!Form::submit('Crear entrada', ['class' => 'btn btn-primary', 'data-toggle' => 'modal', 'data-target' => '#registrar'])!!}
	<br>
    {!!$entradas->render()!!}
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="inicio">Registro de Entradas</h4>
				</div>
				<div class="modal-body">
						{!! Form::open(array('url'=>'entrada', 'method'=>'POST')) !!}
